...
func (pool *Pool) Generate(items int) {
	...
	for i := range pool.farms {
		...
		pool.archers[i].Initialize()
		pool.castles[i].Initialize()
		pool.catapults[i].Initialize()
		pool.cavalry[i].Initialize()
		pool.fences[i].Initialize()
		pool.goldmines[i].Initialize()
		pool.infantry[i].Initialize()
		pool.ships[i].Initialize()
		pool.quarries[i].Initialize()
		pool.towers[i].Initialize()
